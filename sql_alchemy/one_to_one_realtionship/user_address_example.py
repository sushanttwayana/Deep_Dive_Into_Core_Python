...
engine = create_engine('sqlite:///one_to_one_relationships.db')
...
class User(Base):
    ...
    name = Column(String)
    address = relationship('Address', back_populates='user', uselist=False) # uselist = False for onetone relationship
